...
function Movies(){
    ...
    return(
        ...
        <div className="relative w-full h-[100vh] overflow-hidden">
            ...
            <div className="w-full flex items-center  justify-between fixed top-0 z-50 bg-black  text-white">
                <div className="flex items-center gap-10">
                    <Link to="/home"><img src="src\assets\Netflix-Logo.png" className="w-[100px] ml-10" alt="" /></Link>
                    <div className="flex items-center gap-5 font-semibold text-sm">
                        <Link to="/home"><p className="text-[#b8b8b8] hover:text-neutral-400 ">Home</p></Link>
